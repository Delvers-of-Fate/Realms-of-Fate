...
public class SwordEditor extends JPanel {
    ...
    private final ItemsDataService.SwordEntry entry;
    ...
    private final JTextField swingSound = new JTextField();
    private final JTextField wallHitSound = new JTextField();
    ...
    public SwordEditor(ModProject project, ItemsDataService service, ItemsDataService.SwordEntry entry, Listener listener) {
        ...
        JLabel title = new JLabel("Sword");
        title.setForeground(ToolkitColors.TEXT_PRIMARY);
        title.setFont(title.getFont().deriveFont(Font.BOLD, 28f));
        JLabel subtitle = new JLabel("Practical Delver Sword, Weapon and Item properties");
        ...
        row = addField(form, c, row, "Tier", tier, "The melee tier inside items.dat.");
        ...
        row = addField(form, c, row, "Reach", reach, "Distance the sword can hit.");
        ...
        row = addField(form, c, row, "Swing Sound", swingSound, "Comma-separated sound choices are supported by Delver.");
        row = addField(form, c, row, "Wall Hit Sound", wallHitSound, "Sound played when the sword hits the world.");
        ...
        JButton save = new JButton("Save Sword");
    ...
    private void loadValues() {
        name.setText(ItemsDataService.getString(working, "name", "New Sword"));
        ...
        reach.setText(String.valueOf(ItemsDataService.getFloat(working, "reach", 0.5f)));
        ...
        attackAnimation.setText(ItemsDataService.getString(working, "attackAnimation", "swordAttack"));
        attackStrongAnimation.setText(ItemsDataService.getString(working, "attackStrongAnimation", "swordAttackStrong"));
        chargeAnimation.setText(ItemsDataService.getString(working, "chargeAnimation", "swordCharge"));
        ...
        swingSound.setText(ItemsDataService.getString(working, "swingSound", "whoosh1.mp3,whoosh1_02.mp3,whoosh1_03.mp3,whoosh1_04.mp3"));
        wallHitSound.setText(ItemsDataService.getString(working, "wallHitSound", "clang.mp3,clang_02.mp3,clang_03.mp3,clang_04.mp3"));
    ...
    private void save() {
        try {
            ...
            if (itemName.isEmpty()) throw new IllegalArgumentException("Enter a sword name.");
            String tierValue = tier.getText().trim();

            ItemsDataService.putString(working, "class", ItemsDataService.SWORD_CLASS);
            ItemsDataService.putString(working, "itemType", "sword");
            ...
            ItemsDataService.putFloat(working, "reach", parseFloat(reach, "Reach"));
            ...
            putOptionalString("swingSound", swingSound);
            putOptionalString("wallHitSound", wallHitSound);
            ...
            service.saveSword(project, entry, tierValue, working);
            listener.onSaved();
        }
        catch (IllegalArgumentException ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Sword", JOptionPane.WARNING_MESSAGE);
        }
        catch (IOException ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Could Not Save Sword", JOptionPane.ERROR_MESSAGE);
        }
    }
