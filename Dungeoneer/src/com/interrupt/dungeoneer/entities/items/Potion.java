...
public class Potion extends Item {
	...
	public enum PotionType { health, mana, magic, maxhealth, poison, restore, shield, paralyze, resistFire, resistIce, resistPoison, resistLightning }
	...
	public void Drink(Player player) {
		...
		if(potionType == PotionType.health) {
            ...
            displayText = StringManager.get("You feel magical energy return.");

            player.restoreMana(r.nextInt(5) + 4);
        }
	...
	public StatusEffect getStatusEffect() {
        ...
        else if(potionType == PotionType.resistFire) {
            return new ElementalResistanceEffect(
                "Fire Resistance",
                DamageType.FIRE,
                0.50f,
                1000f
        ...
        else if(potionType == PotionType.resistIce) {
            return new ElementalResistanceEffect(
                "Ice Resistance",
                DamageType.ICE,
                0.50f,
        ...
        else if(potionType == PotionType.resistLightning) {
            return new ElementalResistanceEffect(
        ...
        else if(potionType == PotionType.resistPoison) {
            return new ElementalResistanceEffect(
                "Poison Resistance",
                DamageType.POISON,
                0.50f,
