...
import com.interrupt.dungeoneer.statuseffects.ElementalResistanceEffect;
...
public class Actor extends Entity {
        ...
        if(statusEffects != null) {
            for(StatusEffect effect : statusEffects) {
                if(effect != null && effect.active
                    && effect instanceof ElementalResistanceEffect) {

                    ElementalResistanceEffect resistanceEffect =
                        (ElementalResistanceEffect)effect;

                    resistance += resistanceEffect.getResistance(damageType);
                }
            }
        }
	...
	public int takeDamage(int damage, DamageType damageType, Entity instigator) {
        ...
        if(damageType != DamageType.PHYSICAL
            ...
            float resistance = getElementalResistance(damageType);
